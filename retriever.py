...
# Company name → ticker aliases for query detection.
# Defined at module scope to avoid rebuilding on every query.
...
class Retriever:
    ...
    def _detect_companies(self, query: str) -> list[str]:
        ...
        # Match company names via alias dictionary (module-level constant)
